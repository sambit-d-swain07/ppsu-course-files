...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  } else if (pathname.includes('/academic-calendar')) {
    pageTitle = 'Department Academic Calendar Upload';
  }
    ...
    <div className="layout-wrapper">
      ...
      <aside className={sidebarClass}>
        <div className="sidebar-brand">
          ...
          <div className="badge rounded-pill mt-1 sidebar-badge" style={{ background: 'rgba(16, 185, 129, 0.25)', color: '#6EE7B7', fontSize: '0.68rem', fontWeight: 600 }}>
            Admin Portal
          </div>
        </div>
              ...
              <>
                ...
                {profileDropdownOpen && (
                  <div className="profile-menu-popover shadow-lg">
                    ...
                    <Link href="/admin/dashboard" prefetch={false} className="profile-menu-item" onClick={() => setProfileDropdownOpen(false)}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                      </svg>
                      Admin Dashboard
                    </Link>
                    <Link href="/admin/subjects" prefetch={false} className="profile-menu-item" onClick={() => setProfileDropdownOpen(false)}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                      </svg>
                      Subject Allocations
