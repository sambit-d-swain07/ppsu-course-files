...
export default function FacultyProfile() {
  ...
  return (
    <div>
      <div className="mb-4">
        <h4 className="fw-bold text-navy-900">Faculty Profile</h4>
        <p className="text-secondary small">Your account and structural details within P P Savani University.</p>
      </div>
          ...
          <div className="card-custom">
            <div className="d-flex align-items-center gap-3 border-bottom pb-3 mb-4">
              ...
              <div>
                ...
                <span className="text-muted small font-mono-ppsu">{user.employeeId || 'ID NOT ASSIGNED'}</span>
              </div>
            </div>
            ...
            <Table borderless className="align-middle">
              <tbody>
                ...
                <tr className="border-bottom" style={{ borderColor: 'var(--ppsu-border)' }}>
                  <td className="text-secondary fw-semibold py-3">Employee ID:</td>
                  <td className="text-primary py-3 font-mono-ppsu">{user.employeeId || 'N/A'}</td>
                </tr>
                <tr className="border-bottom" style={{ borderColor: 'var(--ppsu-border)' }}>
                ...
                <tr className="border-bottom" style={{ borderColor: 'var(--ppsu-border)' }}>
                  ...
                  <td className="text-primary py-3">{user.designation || 'Faculty Member'}</td>
                </tr>
                <tr className="border-bottom" style={{ borderColor: 'var(--ppsu-border)' }}>
                  <td className="text-secondary fw-semibold py-3">Department:</td>
                  <td className="text-primary py-3">{user.department || 'N/A'}</td>
                </tr>
                <tr className="border-bottom" style={{ borderColor: 'var(--ppsu-border)' }}>
